...
public class ProductController {
	...
	public String modifyPost(ProductVO productVO, @RequestParam(value =  "imgs1") MultipartFile[] imgs1, @RequestParam(value =  "imgs2") MultipartFile[] imgs2) {
		log.info("상품 수정 post-----------------------------------------");
		//코멘트 없으면 초기화
	...
	public String detailGet(@RequestParam(value = "product_id") String product_id, Model model) {
		log.info("상품 상세 get ------------------------------------------------");
	...
	public String detailAdminGet(@RequestParam(value = "product_id") String product_id, Model model) {
