		...
		<form class="section" method="post">
			<div class="section_header">
				...
				<div class="section_header_select">
					...
					<script>
                    	let camping_recruitment = '<c:out value="${data.camping_applicant}"/>'; // 총 모집 인원
                    </script>
			...
			<div class="section_footer">
				<input type="hidden" value="빼로맘" name="member_id">
				<input type="submit" value="글 등록" class="section_footer_registrationBtn">
			</div>
		</form>
	</main>
