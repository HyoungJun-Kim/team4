...
<!--쇼핑몰 글로벌 css-->
<link rel="stylesheet" href="<c:url value="/resources/css/community/freeNotice/detail.css?ver=3"/>">
<!-- 글로벌 css -->
			...
			<div class="section_header">
				...
				<div class="section_header_info">
					...
					<div class="section_header_info_btns">
						<input type="button" value="작성자의 다른 글 보기" class="section_header_info_btns_ohterBtn">
						<input type="button" value="쪽지 보내기 " class="section_header_info_btns_noteBtn">
