		...
		<form method="post">
			...
			<div class="question_Open">
				...
				<div class="question_Open_Radio">
					<label for="question_Open_Radio1"><input type="radio" id="question_Open_Radio1" value="${data.qna_public }" name="qna_public">공개</label> <label for="question_Open_Radio2"><input type="radio" id="question_Open_Radio2" value="${data.qna_public }" name="qna_public">비공개</label>
				</div>
			</div>
