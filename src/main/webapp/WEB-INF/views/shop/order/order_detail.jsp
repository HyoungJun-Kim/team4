			...
			<div class="orderContainer">
				...
				<div class="orderAddressDiv">
					...
					<div class="orderAddressBottom">
						...
						<div class="requestDiv">
							...
							<!-- 메시지 -->
							<textarea name="order_comment" id="requestTextarea" cols="30" rows="10" maxlength="500"></textarea>
				...
				<div class="orderPriceDiv">
					...
					<div class="orderPriceBottom">
						<table>
							<tr>
								<td>선택 상품 <span class="productQuantitySpan">${order_quantity }</span>개 
									금액 <input type="hidden" name="order_quantity" value="${order_quantity }"></td>
								<td>
									<fmt:formatNumber value="${product.product_price * order_quantity }" type="number" />
									<input type="hidden" value="${product.product_price * order_quantity }" id="order_purchase_amount" name="order_purchase_amount">
									 원
								</td>
							</tr>
							<tr>
